...
namespace 
{
    ...
    {
        // create the file
        HANDLE hFile = CreateFile((LPCSTR)"crash.dmp", GENERIC_WRITE, FILE_SHARE_WRITE, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
...
#    endif
    ...
    struct Win32AssertHandler : public AssertHandler 
    {
        ...
        {
            HINSTANCE kernel32 = GetModuleHandle((LPCSTR)"kernel32.dll");
            if (kernel32) {
